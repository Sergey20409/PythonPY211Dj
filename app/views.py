...
def template_view(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            my_checkbox = form.cleaned_data.get('chekbox')

            return JsonResponse({"my_text": my_text, "my_select": my_select, "my_textarea": my_textarea, "my_email": my_email,
                                 "my_password": my_password, "date": my_date, "number": my_number,
...
class MyTemplView(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():  # Проверили, что данные все валидные
            ...
            return JsonResponse({"my_email": my_email,
